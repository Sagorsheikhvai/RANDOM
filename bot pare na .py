...
logo= """
  ...
  '\x1b[1;97m'_____  ___  _____ ___________  
 '\x1b[1;97m'/  ___|/ _ \|  __ \  _  | ___ \ 
 '\x1b[1;97m'\ `--./ /_\ \ |  \/ | | | |_/ / 
 '\x1b[1;97m' `--. \  _  | | __| | | |    /  
 '\x1b[1;97m'/\__/ / | | | |_\ \ \_/ / |\ \  
 '\x1b[1;97m'\____/\_| |_/\____/\___/\_| \_| 
                                
                                

                                             
→   Owner      :  Md SAGOR SHEIKH 
→   Facebook   :  Md SAGOR SHEIKH 
→   Github     :  sagorsheikhvai 
→   Tool Type  :  \x1b[1;95m
...
def Sagor ():
    ...
    print('\33[1;37m----------------------------------------------')
    Sagor = input('[•] Select option  : ')
    if Sagorx=='1':
        annu()
    if Sagorx=='5':
        exit()
    if Sagorx=='3':
        os.system('xdg-open https://github.com/sagorsheikhvai?tab=projects ')
    if Sagorx=='4':
        os.system('xdg-open https://www.facebook.com/Sagor Sheikh'); Sagor ()
    if Sagorx=='2':
        bangla()
    else:
...
def m1():
    ...
    print('Press Enter to Back');Sagor()
#
def m2():
    user=[]
    os.system('clear')
